...
#[test]
fn project_cargo_toml_has_generated_header() {
    let dir = TempDir::new().unwrap();
    init_workspace(&dir);
    ...
    let content = fs::read_to_string(dir.path().join("projects/my_project/Cargo.toml")).unwrap();
    assert!(
        content.starts_with("# GENERATED BY cargo-polylith"),
        "project Cargo.toml should start with GENERATED header, got: {content}"
    );
    assert!(
        content.contains("DO NOT EDIT"),
        "project Cargo.toml GENERATED header should contain DO NOT EDIT: {content}"
    );
}

#[test]
fn component_cargo_toml_does_not_have_generated_header() {
    let dir = TempDir::new().unwrap();
    init_workspace(&dir);
    ...
    let content = fs::read_to_string(dir.path().join("components/my_comp/Cargo.toml")).unwrap();
    assert!(
        !content.contains("GENERATED"),
        "component Cargo.toml must NOT have GENERATED header (user-owned file): {content}"
    );
}

#[test]
fn base_cargo_toml_does_not_have_generated_header() {
    let dir = TempDir::new().unwrap();
    init_workspace(&dir);
    ...
    let content = fs::read_to_string(dir.path().join("bases/my_base/Cargo.toml")).unwrap();
    assert!(
        !content.contains("GENERATED"),
        "base Cargo.toml must NOT have GENERATED header (user-owned file): {content}"
    );
}
